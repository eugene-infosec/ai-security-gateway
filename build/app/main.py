...
from app.auth import Principal, Role # Added because of the move to deps
from app.deps import get_principal # <--- CHANGED IMPORT from auth
...
# --- CRITICAL FIX: Force Lambda Logging ---
# AWS Lambda sets root logger to WARNING by default. 
# We must grab the root logger and forcibly set it to INFO.
