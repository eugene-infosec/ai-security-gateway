...
| E02 | `E02_gate_pass_local.png`          | **Misuse regression suite passes** (`make gate`): no-admin-leakage, tenant-isolation, safe-logging, **supply-chain** |
| E03 | `E03_smoke_dev_output.png`         | **AWS deployed** endpoint passes smoke (`make smoke-cloud`): health, identity, deny path                               |
